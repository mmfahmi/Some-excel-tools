...
def scanUserProfiles():
    ...
    def scanDirectory(writer, directory, allowed_extensions, profile):
       for root, dirs, files in os.walk(directory):
           for file in files:
               ...
               if file_extension in allowed_extensions:
                   ...
                   full_file_path = os.path.join(profile, file_path)
                   writer.writerow([full_file_path, file_extension, file_size])
               user_profiles = []  # Define the user_profiles variable
           ...
           for profile in user_profiles:
               ...
               scanDirectory(writer, documents_dir, allowed_extensions, profile)
               scanDirectory(writer, downloads_dir, allowed_extensions, profile)
               scanDirectory(writer, desktop_dir, allowed_extensions, profile)
